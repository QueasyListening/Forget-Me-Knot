...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      username: '',
      notes: [{ title: 'Welcome to Forget Me Knot', text: 'Sign up for an account to get started', _id: '0', flagColor: 'blue' }, { title: 'Welcome to Forget Me Knot', text: 'Sign up for an account to get started', _id: '1'}],
      loggedInAs: false,
      masterNotes: [],
    }
  }
